...
export const translations: Translations = {
  zh: {
    ...
    specs: {
      ...
      power: "额定功率: 220-240V~, 50-60Hz, 1100W",
      date: "发布日期: 2024年06月",
      manufacturer: "制造商: XIVA Global Tech",
  ...
  en: {
    ...
    specs: {
      ...
      certification: "Safety Cert: SU072738-22002",
      power: "Rated Power: 220-240V~, 50-60Hz, 1100W",
      date: "Release: June 2024",
      manufacturer: "Manufacturer: XIVA Global Tech",
      size: "Size: 480x275x200mm",
      weight: "Weight: 4.33kg"
    }
  },
// 在 translations.ts 的 export const translations 对象中添加以下两个 key
  ...
  ru: {
    ...
    sections: [
      { id: "s1", num: "01", title: "Хрустящий и сочный", subtitle: "Сохраните оригинальный вкус", desc: "Высокоэффективная циркуляция тепла сохраняет влагу, подрумянивая поверхность.", imageUrl: "/P3.png" },
      { id: "s2", num: "02", title: "Верхний и нижний нагрев", subtitle: "Больше не нужно переворачивать", desc: "Мощные двойные нагревательные элементы обеспечивают равномерное приготовление обеих сторон.", imageUrl: "/P4.png" },
      { id: "s3", num: "03", title: "Керамический фильтр", subtitle: "Чистая кухня", desc: "Эффективно улавливает частицы масла и минимизирует дым.", imageUrl: "/P5.png" },
      { id: "s4", num: "04", title: "Окно из Low-E стекла", subtitle: "Точный контроль визуально", desc: "Безопасное низкоэмиссионное стекло обеспечивает четкий обзор без потери тепла.", imageUrl: "/P2.png" }
    ],
    cookingGuide: {
      ...
      items: [
        ...
        { name: "Свиная грудинка", time: "12~15 мин" },
    ...
    specs: {
      ...
      power: "Мощность: 220-240V~, 50-60Hz, 1100W",
      date: "Выпуск: Июнь 2024",
      manufacturer: "Производитель: XIVA Global Tech",
  ...
  ar: {
    ...
    sections: [
      { id: "s1", num: "01", title: "مقرمش وطري", subtitle: "حافظ على النكهة الأصلية", desc: "دوران حراري عالي الكفاءة يحافظ على الرطوبة مع تحمير السطح.", imageUrl: "/P3.png" },
      { id: "s2", num: "02", title: "تسخين علوي وسفلي", subtitle: "لا حاجة للتقليب بعد الآن", desc: "تضمن عناصر التسخين المزدوجة القوية طهياً متساوياً لكلا الجانبين.", imageUrl: "/P4.png" },
      { id: "s3", num: "03", title: "نظام فلتر السيراميك", subtitle: "تجربة مطبخ نظيفة", desc: "يلتقط جزيئات الزيت بفعالية ويقلل من الدخان.", imageUrl: "/P5.png" },
      { id: "s4", num: "04", title: "زجاج Low-E للرؤية", subtitle: "تحكم دقيق تحت نظرك", desc: "زجاج منخفض الانبعاثية يسمح برؤية واضحة دون فقدان الحرارة.", imageUrl: "/P2.png" }
    ],
    cookingGuide: {
    ...
    specs: {
      ...
      power: "الطاقة المقدرة: 220-240 فولت~، 50-60 هرتز، 1100 واط",
      date: "تاريخ الإصدار: يونيو 2024",
      manufacturer: "الشركة المصنعة: XIVA Global Tech",
  ...
  ko: {
    ...
    specs: {
      ...
      power: "소비전력: 220-240V~, 50-60Hz, 1100W",
      date: "출시일: 2024년 06월",
      manufacturer: "제조사: XIVA Global Tech",
  ...
  ja: {
    ...
    specs: {
      ...
      power: "消費電力: 220-240V~, 50-60Hz, 1100W",
      date: "発売日: 2024年06月",
      manufacturer: "製造元: XIVA Global Tech",
