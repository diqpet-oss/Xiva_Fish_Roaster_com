...
export const translations: Translations = {
  zh: {
    ...
    sections: [
      ...
      { id: "s2", num: "02", title: "上下双面加热管", subtitle: "均匀受热，告别翻面繁琐", desc: "上下大功率发热管同时启动，极速锁鲜。", imageUrl: "https://picsum.photos/seed/grill2/800/500" },
  ...
  en: {
    ...
    sections: [
      ...
      { id: "s2", num: "02", title: "Top & Bottom Heating", subtitle: "No more flipping needed", desc: "Powerful dual heating elements ensure even cooking for both sides.", imageUrl: "https://picsum.photos/seed/grill2/800/500" },
  ...
  ko: {
    ...
    sections: [
      ...
      { id: "s2", num: "02", title: "상하 열선 양면 그릴", subtitle: "뒤집을 필요 없는 편리함", desc: "상하 동시 가열로 열 손실을 줄이고 조리 시간을 단축합니다.", imageUrl: "https://picsum.photos/seed/grill2/800/500" },
  ...
  ja: {
    ...
    sections: [
      ...
      { id: "s2", num: "02", title: "上下ダブルヒーター", subtitle: "手間いらずの両面焼き", desc: "上下からの強力熱線で、均一に焼き上げます。", imageUrl: "https://picsum.photos/seed/grill2/800/500" },
